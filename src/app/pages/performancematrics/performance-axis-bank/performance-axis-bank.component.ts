...
@Component({
  selector: 'app-performance-axis-bank',
  templateUrl: './performance-axis-bank.component.html',
  styleUrl: './performance-axis-bank.component.css'
})
export class PerformanceAxisBankComponent {
